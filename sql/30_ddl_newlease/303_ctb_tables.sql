...
CREATE TABLE IF NOT EXISTS ctb_dept_allocation (
    ...
    dept_cd             VARCHAR(12)     NOT NULL,           -- 費用負担する部署コード (M7 P.70)
    allocation_ratio    NUMERIC(5,2)    NOT NULL,           -- 各部門への按分比率 (M7 P.70)
...
COMMENT ON TABLE ctb_dept_allocation IS '多部門配賦テーブル（定義書準拠）';
