...
Public Class KeijoSqlBuilder
    ...
    Public Shared Function BuildSourceSql(
        ...
        sb.AppendLine("  m.lcpt_id,")
        sb.AppendLine("  m.hensai_kind,")
        sb.AppendLine("  m.shri_kn,")
        sb.AppendLine("  m.shri_cnt,")
        sb.AppendLine("  m.sshri_kn_m,")
        sb.AppendLine("  m.sshri_kn_1,")
        sb.AppendLine("  m.sshri_kn_2,")
        sb.AppendLine("  m.sshri_kn_3,")
        sb.AppendLine("  m.shho_m_id,")
        sb.AppendLine("  m.shho_1_id,")
        sb.AppendLine("  m.shho_2_id,")
        sb.AppendLine("  m.shho_3_id,")
        sb.AppendLine("  m.mae_dt,")
        sb.AppendLine("  m.shri_dt1,")
        sb.AppendLine("  m.shri_dt2,")
        sb.AppendLine("  m.shri_dt3,")
        sb.AppendLine("  m.zritu,")
        ...
        sb.AppendLine("  m.jencho_f,")
        sb.AppendLine("  m.start_dt,")
        sb.AppendLine("  m.b_rend_dt,")
        sb.AppendLine("  m.kyak_dt,")
        sb.AppendLine("  m.ckaiyk_esdt_t,")
        sb.AppendLine("  m.ckaiyk_esdt_h,")
        sb.AppendLine("  m.skyu_kj_f,")
        sb.AppendLine("  m.k_kjyo_st_dt,")
    ...
    Public Shared Function BuildHenfSql(meisai As ShriMeisai) As String
        ...
        sb.AppendLine("  f.f_lcpt_id,")
        sb.AppendLine("  f.f_hkmk_id,")
        ...
        sb.AppendLine("ORDER BY f.kykm_id, f.henf_id")
        Return sb.ToString()
    End Function
