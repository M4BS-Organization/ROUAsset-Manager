...
Partial Public Class FrmContractEntry
    Inherits Form
    ...
    Public Sub LoadContractById(id As Double)
        ...
        Try
            ...
            If dtHead.Rows.Count > 0 Then
                ...
                ' 支払日
                txt_SHRI_DT1.Text = row("shri_dt1")
                txt_SHRI_DT2.Text = row("shri_dt2")
                txt_SHRI_DT3.Text = row("shri_dt3")
                ...
                ' --- 明細取得 (ID指定) ---
                Dim sqlDetail As String = "SELECT * FROM d_kykm WHERE kykh_id = @id ORDER BY kykm_no"
                Dim dtDetail As DataTable = _crud.GetDataTable(sqlDetail, prmHead) ' パラメータは同じ@idでOK
